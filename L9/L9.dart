...
Future fetchMjolnir() async {
  String url = 'https://blogspotscraping.herokuapp.com/mjolnir.json';

  var request = await HttpClient().getUrl(Uri.parse(url));
  var response = await request.close();
  await for (var contents in response.transform(Utf8Decoder())) {
    var getJson = json.decode(contents);
    var getGadget =  getJson['Gadget'];
    print('Thor get $getGadget');
    return getGadget;
  }
}
